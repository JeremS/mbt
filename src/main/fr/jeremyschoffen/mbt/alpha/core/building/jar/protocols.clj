...
(defprotocol JarSource
  ...
  (to-entries [this] [this exclude]
    "Function making instances of [[fr.jeremyschoffen.mbt.alpha.core.building.jar.protocols/JarEntries]].

    Args:
    - `this`: the value out of which we want to make a
    [[fr.jeremyschoffen.mbt.alpha.core.building.jar.protocols/JarEntries]].
    - `exclude`: An exclusion function that will be specific to the
      [[fr.jeremyschoffen.mbt.alpha.core.building.jar.protocols/JarEntries]] being made. If this function returns true,
...
(defprotocol JarEntries
  ...
  (add! [this conf]
    ...
    use of [[fr.jeremyschoffen.mbt.alpha.core.building.jar.temp/add-entries]] is the obvious way.

    Args:
    - `this`: the instance of [[fr.jeremyschoffen.mbt.alpha.core.building.jar.protocols/JarEntries]] which contains
